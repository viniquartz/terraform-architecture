locals {
  ...
  # Base naming pattern without suffix
  base_name_no_suffix = "azr_${var.environment}_${var.project_name}${var.project_version}_${local.region_abbr}"
  
  # Base naming pattern with optional suffix
  base_name = var.suffix != "" ? "${local.base_name_no_suffix}_${var.suffix}" : local.base_name_no_suffix
}
